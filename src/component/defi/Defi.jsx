    ...
    return (
        <div>
            <div style={{ display: 'flex', alignItems: 'center', marginTop: '50px', marginLeft: "100px" }}>
                ...
                <BoxItem boxwidth='105px' boxheight='109px' pboxwidth='54px' pboxheight='6px' />
                <div className='welc'>ME</div>
                <BoxItem boxwidth='105px' boxheight='109px' pboxwidth='49px' pboxheight='8px' />
            </div>

            <div style={{ display: 'flex', alignItems: 'center', marginLeft: "100px" }}>
                <div className='welc' style={{ marginLeft: "500px",marginTop:'-70px' }}>To Connected</div>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', marginLeft: "100px"  }}>
            ...
            <div style={{marginTop:'200px', marginRight:'100px',marginLeft:'150px'}} >
                <Lunach />
            </div>
